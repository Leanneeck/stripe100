...
growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Course", author: "Mattan Griffel", price: "4.99", sku: "GROWHACK1", download_url: "https://s3.amazonaws.com/stripe-payments-100/LeanneEckelberg+(2).pdf", details: "You'll get one video", description: %{            <p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
growth_hacking_monthly = Product.create(
	...
	download_url: "https://s3.amazonaws.com/one_month_stripe_payment/Peter+Bell+Resume.pdf",
	description: %{
